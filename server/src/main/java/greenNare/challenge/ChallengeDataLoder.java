...
//
//    public ChallengeDataLoder(ChallengeRepository challengeRepository, ReplyRepository replyRepository, MemberRepository memberRepository, CacheService cacheService) {
...
//        SecurityConfiguration securityConfiguration = new SecurityConfiguration(jwtTokenizer, authorityUtils, cacheService);
